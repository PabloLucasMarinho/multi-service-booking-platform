...
class UpdateAppointmentRequest extends BaseFormRequest
{
  ...
  {
    return [
      'scheduled_at' => ['required', 'date', 'date_format:Y-m-d H:i:s', 'after_or_equal:today', new NoConflictingAppointment(userUuid: $this->input('user'), excludeUuid: $this->route('appointment')?->uuid)],
